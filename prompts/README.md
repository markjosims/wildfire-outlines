...
- For the Proctor, Grader models: student=user, proctor=assistant
...
- clarify: Prompt given to proctor following a student request for clarification
    and following the proctor's response
- answer: Prompt given to proctor following a student answer attempt
